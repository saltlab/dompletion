define(function(require, exports, module) {
	...
	function getMathces(DOMString,partialDOM) {
    	...
    	//code for showing dom selector
    	var DS = DOMString.substring(1).replace(/\s/g,"/");
    	var elem = document.getElementById("domSelector");
    	elem.style.display = "block";
    	elem.href = "http://localhost:8888/lib/ace/autocomplete/domplete/selector.html?start=1#" + DS;
    	//
